...
/** @file QC_XPubZSocket.h defines the c++ implementation of the XPubZSocket class */
/*
  QC_XPubZSocket.h
...
public:
   // creates the object
   DLLLOCAL QoreXPubZSock(const char* endpoint) : QoreZSock(zsock_new_pub(endpoint)) {
   }
};
