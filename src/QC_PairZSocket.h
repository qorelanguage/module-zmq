...
/** @file QC_PairZSocket.h defines the c++ implementation of the PairZSocket class */
/*
  QC_PairZSocket.h
...
public:
   // creates the object
   DLLLOCAL QorePairZSock(const char* endpoint) : QoreZSock(zsock_new_pub(endpoint)) {
   }
};
