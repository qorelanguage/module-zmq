...
/** @file QC_PushZSocket.h defines the c++ implementation of the PushZSocket class */
/*
  QC_PushZSocket.h
...
public:
   // creates the object
   DLLLOCAL QorePushZSock(const char* endpoint) : QoreZSock(zsock_new_pub(endpoint)) {
   }
};
